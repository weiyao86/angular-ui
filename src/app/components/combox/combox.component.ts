import { forwardRef, AfterContentInit, AfterContentChecked, TemplateRef, OnInit, Component, HostListener, Input, Output, EventEmitter, Renderer2, ViewEncapsulation, ViewChild, ElementRef } from '@angular/core';
